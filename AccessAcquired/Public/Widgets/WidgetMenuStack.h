...
public:
	...
	void PauseStackTransitions(EWidgetStack Stack);

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable)
	void ResumeStackTransitions(EWidgetStack Stack);
